/**
 * File: crc.ts
 * Source: Quake II original / qcommon/crc.c and qcommon/crc.h
 * Purpose: Port the CCITT CRC helpers used by Quake II message checksums.
 *
 * Porting policy:
 ...
 *
 * Deviations:
 * - Returns updated CRC values instead of mutating `unsigned short *` arguments.
 *
 * Notes:
 * - This file is the principal TypeScript attachment point for `qcommon/crc.c`
 *   and `qcommon/crc.h`.
 */
